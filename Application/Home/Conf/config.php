...
//        'saveName' => array('uniqid', ''), //上传文件命名规则，[0]-函数名，[1]-参数，多个参数使用数组
    ...
    'UPLOAD_QINIU_CONFIG'=>array(
        'accessKey'=>'Ng9Nft6m4o9fDNdbMzUmj4CaBpHDvhQkXMuoeDOj',
        'secrectKey'=>'Lh8fq5dy5NdURQwFKx8WLt_ZFXRojI2SLJ5q6uwH',
        'bucket'=>'hhhormean',
        'domain'=>'oab1rbnp9.bkt.clouddn.com',
        'timeout'=>3600,
    ),


    /* 编辑器图片上传相关配置 */
    'PAINTING_UPLOAD' => array(
        'mimes'    => '', //允许上传的文件MiMe类型
        'maxSize'  => 2*1024*1024, //上传的文件大小限制 (0-不做限制)
        'exts'     => 'jpg,gif,png,jpeg', //允许上传的文件后缀
        'autoSub'  => true, //自动子目录保存文件
