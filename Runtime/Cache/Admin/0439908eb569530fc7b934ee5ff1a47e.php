...
<body>
    ...
    <div class="main-title">
        <h2><?php echo isset($info['id'])?'编辑':'新增';?>专辑</h2>
    </div>
    <form action="<?php echo U();?>" method="post" class="form-horizontal" enctype="multipart/form-data">
        ...
        <?php if(isset($info['cover'])): ?><div class="form-item" >
                <img src="<?php echo ($info["cover"]); ?>" alt="" width="200px">
            </div><?php endif; ?>

        <div class="form-item">
            <label class="item-label"><span class="must">*</span>总章节数<span class="check-tips"></span></label>
            <div class="controls">
                <input type="number" class="number input-small" name="section_count" value="<?php echo ($info["section_count"]); ?>" min="1">
            </div>
        </div>
        <div class="form-item">
            ...
            <div class="controls">
                <label class="textarea input-large">
                    <textarea name="description" placeholder="请输入对专辑的描述"><?php echo ($info["description"]); ?></textarea>
                </label>
            </div>
        </div>
        <div class="form-item">
            ...
            <div class="controls">
                <select name="category" >
                    <?php if(is_array($Menus)): $i = 0; $__LIST__ = $Menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i; if($info['category'] == $menu["id"] ): ?><option value="<?php echo ($menu["id"]); ?>" selected="selected"><?php echo ($menu["title_show"]); ?></option>
                            <?php else: ?>
                            <option value="<?php echo ($menu["id"]); ?>"><?php echo ($menu["title_show"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
