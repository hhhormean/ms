...
<body>
    ...
    <div class="cf">
        <a class="btn" href="">上传作品</a>
    </div>
    <form method="post" action="<?php echo U('Video/upload_img');?>" enctype="multipart/form-data">
        <input type="file" class="ke-upload-file" name="imgFile" tabindex="-1" style="width: 72px;">
        ...
        <form class="ids">
            <table>
                ...
                <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo (date($vo["date"])); ?></td>
                            <td>
                               <a href="<?php echo ($vo["pic_url"]); ?>"><?php echo ($vo["pic_url"]); ?></a>
                            </td>
                            <td>
                                <a class="confirm ajax-get btn" title="删除" href="<?php echo U('pic_del?id='.$vo['id']);?>">删除</a>
                            </td>
