...
<body>
    ...
    <div class="cf">
        <a class="btn" href="<?php echo U('add',array('pid'=>I('get.pid',0)));?>"><?php if($data): ?>新增课程
            <?php else: ?>新增单元<?php endif; ?></a>
        ...
        <!--<div class="search-form fr cf">-->
            <!--<div class="sleft">-->
                ...
                <!--<a class="sch-btn" href="javascript:;" id="search" url="/ms/index.php?s=/Admin/Video/myAlbum.html"><i class="btn-search"></i></a>-->
            <!--</div>-->
        <!--</div>-->
    </div>
        ...
        <form class="ids">
            <table>
                ...
                <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <?php if($data): echo ($menu["title"]); ?>
                                    <?php else: ?> <a href="<?php echo U('index?pid='.$menu['id']);?>"><?php echo ($menu["title"]); ?></a><?php endif; ?>

                            </td>
                            <td><?php echo ((isset($data["title"]) && ($data["title"] !== ""))?($data["title"]):'无'); ?></td>
                            <td><?php echo ($menu["sort"]); ?></td>
                            <td>


                                <?php if($data): ?><a title="编辑" href="<?php echo U('video_edit?id='.$menu['id']);?>">编辑</a>
                                    <?php else: ?>
                                    <a title="编辑" href="<?php echo U('edit?id='.$menu['id']);?>">编辑</a><?php endif; ?>
