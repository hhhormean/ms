...
<body>
    ...
    <div class="main-title">
        <h2><?php if(isset($data)): ?>[ <?php echo ($data["title"]); ?> ] 子<?php endif; ?>分类管理 </h2>
    </div>
    ...
    <div class="cf">
        ...
        <!--<div class="search-form fr cf">-->
            <!--<div class="sleft">-->
                ...
                <!--<a class="sch-btn" href="javascript:;" id="search" url="/ms/index.php?s=/Admin/VideoCategory/index.html"><i class="btn-search"></i></a>-->
            <!--</div>-->
        <!--</div>-->
    </div>
