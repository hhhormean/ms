...
<body>
    ...
    <div class="cf">
        <!--<a class="btn" href="<?php echo U('video/add',array('album_id'=>I('get.id',0)));?>">新增课程</a>-->
    ...
    <div class="data-table table-striped">
        <form class="ids">
            <table>
                ...
                <tbody>
                <?php if(!empty($data["section_detail"])): if(is_array($data["section_detail"])): $i = 0; $__LIST__ = $data["section_detail"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                            <td><input class="ids row-selected" type="checkbox" name="id[]" value="<?php echo ($menu["id"]); ?>"></td>

                            <td><?php echo ($menu["title"]); ?></td>
                            <td><?php echo ($menu["view"]); ?></td>
                            <td><?php echo ($menu["comment"]); ?></td>
                            <td><?php echo (time_format($menu["update_time"])); ?></td>

                            <td>
                                <a href="<?php echo ($menu["url"]); ?>">观看</a>
                                <a title="编辑" href="<?php echo U('Video/video_edit?id='.$menu['id']);?>">编辑</a>
                                <a class="confirm ajax-get" title="删除" href="<?php echo U('video_del?id='.$menu['id']);?>">删除</a>
                            </td>
    ...
    <script type="text/javascript">
        $(function() {
            //导航高亮
            highlight_subnav('<?php echo U('admin');?>');
        });
    </script>
