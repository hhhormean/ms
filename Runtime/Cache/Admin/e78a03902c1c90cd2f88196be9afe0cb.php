...
<body>
    ...
    <?php if(is_array($data)): foreach($data as $key=>$vo): echo ($vo["id"]); ?> -
        <?php switch($vo["type"]): case "carousel": ?>轮播 -<?php break;?>
            <?php case "video": ?>精品视频 -<?php break;?>
            <?php case "big_news": ?>大学习头条 -<?php break;?>
            <?php case "news": ?>小学习头条 -<?php break;?>
            <?php default: ?>
            未知分类<?php endswitch;?>
        <?php echo ($vo["title"]); ?> -
        <?php echo ($vo["cover"]); ?> -
        <?php echo ($vo["view_num"]); ?> -
        <?php echo ($vo["des"]); ?> -
        <?php echo ($vo["url"]); ?>
