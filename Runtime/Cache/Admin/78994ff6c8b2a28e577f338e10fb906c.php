...
<body>
    ...
    <!-- 主体 -->
    <?php if(is_array($licenses)): foreach($licenses as $key=>$vo): echo ($vo["id"]); ?> -
        <?php echo ($vo["license"]); ?> -
        <?php echo (date("Y-m-d H:i:s",$vo["create_time"])); ?> -
        <?php switch($vo["license_status"]): case "0": ?>未使用<?php break;?>
            <?php case "-1": ?>已使用 -
                <?php echo (date("Y-m-d : H:i:s",$vo["use_time"])); ?> -
                <?php echo ($vo["user_phone"]); break;?>
