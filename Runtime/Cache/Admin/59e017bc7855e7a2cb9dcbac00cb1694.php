...
<body>
    ...
    <div class="cf">
        <!--<a class="btn" href="<?php echo U('add');?>">新建专辑</a>-->
        ...
        <form class="ids">
            <table>
                ...
                <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><a href="<?php echo U('detail?id='.$menu['id']);?>"><?php echo ($menu["title"]); ?></td>
                            <td><?php echo get_username($menu['uid']);?></td>

                            <td><?php echo ($menu["category"]); ?></td>
                            <td><?php echo ($menu["view"]); ?></td>
                            <td><?php echo ($menu["section_count"]); ?></td>
